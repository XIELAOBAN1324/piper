...
class C_PiperRosNode():
    ...
    def enable_callback(self, enable_flag:Bool):
        ...
        if(enable_flag.data):
            ...
            self.__enable_flag = False
            rospy.logwarn("[SAFETY][DANGEROUS] DisableArm(7) requested from enable_callback.")
    ...
    def handle_enable_service(self,req):
        ...
        while not (loop_flag):
            ...
            if(req.enable_request):
                ...
                rospy.logwarn("[SAFETY][DANGEROUS] DisableArm(7) requested from enable service.")
                self.piper.DisableArm(7)
    ...
    def handle_stop_service(self,req):
        ...
        rospy.loginfo(f"-----------------------STOP---------------------------")
        rospy.logerr("[SAFETY][DANGEROUS] MotionCtrl_1(0x01, 0, 0) emergency stop requested from stop service.")
